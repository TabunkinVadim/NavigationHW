...
class ProfileHeaderView: UITableViewHeaderFooterView {
    ...
    override func layoutSubviews() {
        ...
        contentView.addSubviews(avatar, name, statusButtom, status, statusSet)
        
        NSLayoutConstraint.activate([
            avatar.topAnchor.constraint(equalTo: contentView.safeAreaLayoutGuide.topAnchor, constant: 16),
